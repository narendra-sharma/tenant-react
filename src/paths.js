export const paths = {
  ...
  'dashboard.admin.update.user': (userId)=>`/admin/users/update/${userId}`,
  'dashboard.admin.update.devices': (userId)=>`/admin/devices/update/${userId}`,
  'dashboard.admin.device_details': (deviceId)=>`/devices/${deviceId}`
};
