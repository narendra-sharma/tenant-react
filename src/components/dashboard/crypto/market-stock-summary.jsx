    ...
    <Card>
      ...
      <Stack direction="row" spacing={3} sx={{ flexWrap: 'wrap' }}>
        <Stack direction="row" spacing={1} sx={{ alignItems: 'center', flexGrow: 1 }}>
          ...
          >
            <CurrencyBtcIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />
          </Avatar>
          <div>
        ...
        <Stack spacing={0.5}>
          ...
          <Typography level="h4">$30,205.70</Typography>
        </Stack>
        <Stack spacing={0.5}>
          <Typography level="body-xs">Change</Typography>
          <Typography level="h4">+5.21%</Typography>
        </Stack>
        <Stack spacing={0.5}>
      ...
      {payload?.map((entry) => (
        <Stack key={entry.name} spacing={1}>
          ...
          {[
            ...
            <Stack direction="row" key={item.label} spacing={2} sx={{ justifyContent: 'space-between' }}>
              <Typography level="body-xs" textColor="text.primary">
                {item.label}
              </Typography>
              <Typography level="body-xs">{item.value}</Typography>
            </Stack>
          ))}
        </Stack>
      ))}
