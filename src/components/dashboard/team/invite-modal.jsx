          ...
          <Stack spacing={8}>
            <Stack spacing={1}>
              <div>
                <IconButton
                  ...
                  variant="soft"
                >
                  <CaretLeftIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />
                </IconButton>
              </div>
              <Stack spacing={2}>
            ...
            <FormControl>
              ...
              <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
                <Input name="inviteUrl" readOnly sx={{ flexGrow: 1 }} value={inviteUrl} />
                <IconButton color="neutral" variant="outlined">
                  <LinkIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />
                </IconButton>
              </Stack>
            </FormControl>
          </Stack>
              ...
              <Stack spacing={3}>
                ...
                <Stack spacing={1}>
                  <FormControl>
                    ...
                    <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
                      <Input name="email" sx={{ flexGrow: 1 }} type="email" />
