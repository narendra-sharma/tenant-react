            ...
            >
              <Stack direction="row" spacing={3} sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
                <Stack spacing={1}>
                  ...
                  <Typography level="h2">{entry.amount}</Typography>
                </Stack>
                <Stack spacing={0.5}>
                  <Chip
                    ...
                    startDecorator={
                      entry.trend === 'up' ? (
                        <TrendUpIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />
                      ) : (
                        <TrendDownIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />
                      )
                    }
                    variant="soft"
                  >
