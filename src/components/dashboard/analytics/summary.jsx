      ...
      >
        <Stack spacing={2}>
          ...
          <Chip
            color="success"
            size="sm"
            startDecorator={<ArrowUpRightIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />}
            variant="soft"
          >
            13%
          </Chip>
        ...
        <Stack spacing={2}>
          ...
          <Chip
            color="danger"
            size="sm"
            startDecorator={<ArrowDownRightIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />}
            variant="soft"
          >
            11.5%
          </Chip>
