      ...
      <Stack direction="row" spacing={2} sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div>
          {dueDate ? (
            <Typography
              level="body-xs"
              startDecorator={<ClockIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />}
            >
      ...
      <Stack direction="row" spacing={2} sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <Stack direction="row" spacing={1}>
          {subtasks.length ? (
            <Typography
              level="body-xs"
              startDecorator={<ListIcon style={{ fontSize: 'var(--joy-fontSize-md)' }} weight="bold" />}
            >
              {subtasks.length}
            </Typography>
          ) : null}
          {attachments.length ? (
            <Typography
              level="body-xs"
              startDecorator={<PaperclipIcon style={{ fontSize: 'var(--joy-fontSize-md)' }} weight="bold" />}
            >
              {attachments.length}
            </Typography>
          ) : null}
          {comments.length ? (
            <Typography
              level="body-xs"
              startDecorator={<ChatCenteredDotsIcon style={{ fontSize: 'var(--joy-fontSize-md)' }} weight="bold" />}
            >
          ...
          {watchers ? (
            <Typography
              level="body-xs"
              startDecorator={<EyeIcon style={{ fontSize: 'var(--joy-fontSize-md)' }} weight="bold" />}
            >
              {watchers}
            </Typography>
          ) : null}
