            ...
            >
              ...
              <Stack direction="row" spacing={2} sx={{ alignItems: 'center', flexWrap: 'wrap' }}>
                {attachments?.map((attachment) => (
                  ...
                  >
                    <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
                      <div>
                        <FileIcon style={{ fontSize: 'var(--joy-fontSize-xl)' }} weight="bold" />
                      </div>
                      <div>
                ...
                <IconButton color="neutral" size="sm">
                  <PlusIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />
                </IconButton>
              </Stack>
            </Sheet>
            <Sheet
            ...
            <Sheet sx={{ borderRadius: 'var(--joy-radius-sm)', p: 3 }} variant="outlined">
              <Stack divider={<Divider />} spacing={2}>
                ...
                <Stack
                  spacing={2}
                  sx={{
                    '&:not(:hover) > div:first-of-type button': {
                      visibility: 'hidden',
                    },
                  }}
                >
                  ...
                  {dueDate ? (
                    <Typography
                      fontSize="sm"
                      fontWeight="md"
                      startDecorator={<CalendarIcon style={{ fontSize: 'var(--joy-fontSize-xl)' }} weight="bold" />}
                    >
                      {dayjs(dueDate).format('MMMM D, YYYY hh:mmA')}
                    </Typography>
                  ) : null}
                </Stack>
                <Stack
                        ...
                        <TimelineContent>
                          <Stack spacing={1}>
                            <Typography level="body-xs">
                              {dayjs(event.createdAt).format('MMMM D, YYYY hh:mmA')}
                            </Typography>
...
function EditableTitle({ onUpdate, title }) {
  ...
  return (
    <Stack direction="row" spacing={2}>
      <Typography fontSize={{ xs: 'lg', md: 'xl2' }} level="h4" noWrap sx={{ flexGrow: 1 }}>
        {copy}
      </Typography>
      <div>
        <IconButton
    ...
    <Input
      endDecorator={
        <IconButton
          ...
          variant="plain"
        >
          <PaperPlaneTiltIcon style={{ fontSize: 'var(--Icon-fontSize)' }} weight="bold" />
        </IconButton>
      }
      name="comment"
      onChange={(event) => {
